    ...
    media.addEventListener('click', () => {
      ...
      closeBtn.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          <path d="M13.5303 9.62305L13.3105 10L13.5303 10.377L17.9229 17.9229L10.377 13.5303L10 13.3105L9.62305 13.5303L2.07617 17.9229L6.46973 10.377L6.68945 10L6.46973 9.62305L2.07617 2.07617L9.62305 6.46973L10 6.68945L10.377 6.46973L17.9229 2.07617L13.5303 9.62305Z" stroke="#1F2937" stroke-width="1.5"/>
        </svg>
      `;
...
initMobileSwiper() {
  const container = document.querySelector(".pdp-media-sm");
  if (!container) return;
  ...
  handleAddToCart(e) {
    ...
    fetch(window.Shopify.routes.root + "cart/add.js", {
      ...
      .finally(() => {
        ...
        if (this.closest(".pqv-wrapper").querySelector('.pqv-close-btn')){
            this.closest(".pqv-wrapper").querySelector('.pqv-close-btn').click();
        }
